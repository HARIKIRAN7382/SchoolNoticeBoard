...
extension Date {
    ...
    func previousWeek() -> Date {
        return addingTimeInterval(-7*24*60*60) as Date
    }
    
    func nextDay() -> Date {
        return addingTimeInterval(1*24*60*60) as Date
    }
    ...
    func previousMonth() -> Date {
        return addingTimeInterval(-30*24*60*60) as Date
    }
    func previousYear() -> Date {
        return addingTimeInterval(-365*24*60*60) as Date
    }
